...
X_tot_test = [get_image(sample_file,img_size,img_size) for sample_file in test_img_list]
X_test,edge_x_test = [],[]
...
Y_tot_test = [get_image(sample_file,img_size,img_size,gray=True) for sample_file in test_mask_list]
Y_test,edge_y_test = [],[]
for i in range(0,len(test_img_list)):
